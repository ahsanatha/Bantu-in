...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="intro-section" id="home-section">
      ...
      <div class="slide-1" style="background-image: url('<?php echo base_url(); ?>assets/images/maid.jpg');" data-stellar-background-ratio="0.5">
        <div class="container">
            ...
            <div class="col-12">
              <div class="row align-items-center">
                <div class="col-lg-6 mb-4">
                  ...
                  <p class="mb-4"  data-aos="fade-up" data-aos-delay="200">Peran pekerja rumah sangat penting dalam kehidupan sehari-hari. Semakin banyak wanita yang menjadi wanita karier dan sibuk dengan pekerjaan sendiri sehingga kebutuhan akan tenaga kerja yang profesional sangat tinggi. Basik asisten rumah tangga, perawat, ataupun babysitter. Berdasarkan hal tersebut, makan kami tertarik untuk menbuat suatu aplikasi berbasis web yang akan menjembatani antara orang yang membutuhkan pekerjaan dengan orang yang membutuhkan jasa pekerja.</p>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="100">
            <div class="teacher text-center">
              <img src="<?php echo base_url() ?>assets/images/dion.jpg" alt="Image" class="img-fluid w-50 rounded-circle mx-auto mb-4">
              <div class="py-2">
          ...
          <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="100">
            <div class="teacher text-center">
              <img src="<?php echo base_url() ?>assets/images/atta.jpg" alt="Image" class="img-fluid w-50 rounded-circle mx-auto mb-4">
              <div class="py-2">
          ...
          <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="200">
            <div class="teacher text-center">
              <img src="<?php echo base_url() ?>assets/images/almer.jpg" alt="Image" class="img-fluid w-50 rounded-circle mx-auto mb-4">
              <div class="py-2">
          ...
          <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="300">
            <div class="teacher text-center">
              <img src="<?php echo base_url() ?>assets/images/felia.jpg" alt="Image" class="img-fluid w-50 rounded-circle mx-auto mb-4">
              <div class="py-2">
    ...
    <div class="site-section bg-image overlay" style="background-image: url('<?php echo base_url(); ?>assets/images/maid.jpg');">
      <div class="container">
        <div class="row justify-content-center align-items-center">
          <div class="col-md-8 text-center testimony">
            <h3 class="mb-4">(HR. Muslim)</h3>
            <blockquote>
              <p>&ldquo; Allah akan menolong seorang hamba, selama hamba itu senantiasa menolong saudaranya &rdquo;</p>
            </blockquote>
          </div>
        </div>
      </div>
