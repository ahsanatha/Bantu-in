                    ...
                    <div class="ml-auto w-25">
                        <nav class="site-navigation position-relative text-right" role="navigation">
                            <ul
                                ...
                                <li class="cta"><a href="<?php echo site_url('C_Customer/signin'); ?>"
                                        class="nav-link"><span>Sign In</span></a></li>
                                <li class="cta"><a href="<?php echo site_url('C_Customer/signup'); ?>"
                                ...
                                <div class="col-12">
                                    <div class="row align-items-center">
                                        <div class="col-lg-6 mb-4">
                                            ...
                                            <p class="mb-4" data-aos="fade-up" data-aos-delay="200">Peran pekerja rumah
                                                sangat
                                                penting dalam kehidupan sehari-hari. Semakin banyak wanita yang menjadi
                                                wanita
                                                karier dan sibuk dengan pekerjaan sendiri sehingga kebutuhan akan tenaga
                                                kerja
                                                yang profesional sangat tinggi. Basik asisten rumah tangga, perawat,
                                                ataupun
                                                babysitter. Berdasarkan hal tersebut, makan kami tertarik untuk menbuat
                                                suatu
                                                aplikasi berbasis web yang akan menjembatani antara orang yang
                                                membutuhkan
                        ...
                        <div class="row">
                            ...
                            <div class="owl-carousel col-12 nonloop-block-14">
                                ...
                                <div class="course bg-white h-100 align-self-stretch">
                                    <figure class="m-0">
                                        <a href="course-single.html"><img
                                                src="<?php echo base_url() ?>assets/images/nurse.jpg" alt="Image"
                                                class="img-fluid"></a>
                                    </figure>
                                    <div class="course-inner-text py-4 px-4">
                                        <div class="meta"></div>
                ...
                <div class="container">
                    <div class="row justify-content-center align-items-center">
                        <div class="col-md-8 text-center testimony">
                            ...
                            <blockquote>
                                <p>&ldquo; Allah akan menolong seorang hamba, selama hamba itu senantiasa menolong
                                    saudaranya
                                    &rdquo;</p>
                            </blockquote>
                        </div>
