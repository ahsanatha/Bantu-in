    ...
    <div class=" container registAst col-md-7 py-3">
        <div class="card">
            <header class="card-header">
                <a href="<?= site_url('C_signinCst')?>" class="float-right btn btn-outline-info mt-1" id="btn_ast">Sign
                    in</a>
                                ...
                                <div class="card-body">
                                    <form action="">
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-md-2"><button class="btn btn-info" type="submit"> <a
                                                        href="<?= site_url('#')?>">Sign Up</a></button></div>
                                        </div>
                                    </form>
                                </div>
                            </div>
